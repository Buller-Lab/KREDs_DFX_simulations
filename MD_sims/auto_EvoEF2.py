...
def repair_pdb(input_pdb, output_folder):
    repair_command = f"/mnt/bkup/tools/evoef_stability/EvoEF2/EvoEF2 --command=RepairStructure --pdb={input_pdb}"
...
def compute_stability(input_pdb):
    stability_command = f"/mnt/bkup/tools/evoef_stability/EvoEF2/EvoEF2 --command=ComputeStability --pdb={input_pdb}"
...
if __name__ == "__main__":
    input_folder = "EvoEF2_input"
    output_folder = "EvoEF2_output"
    output_csv = "EvoEF2_output/EvoEF2.csv"
